...
# This is a series of helper functions copy/pasted from many other repos that use BATS for testing. 
# The code isn't pretty, and doesn't follow many of our conventions, but it's useful.
